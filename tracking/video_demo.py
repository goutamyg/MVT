...
def main():
    ...
    parser.add_argument('--tracker_param', type=str, default='mobilevit_256_64x2_got10k_ep100_cosine_annealing', help='Name of parameter file.')

    parser.add_argument('--videofile', type=str, default='/home/goutam/Datasets/test_data/lasot/skateboard-19', help='path to a video file.')
    parser.add_argument('--optional_box', type=float, default=[107,452,213,70], nargs="+", help='optional_box with format x y w h.')
